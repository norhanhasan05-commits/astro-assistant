...
app = FastAPI(title="Astro Assistant", version="2.5")
...
def simple_positions_table(title: str, positions: dict) -> str:
    ...
    for name in ("Sun", "Moon", "Mercury", "Venus", "Mars", "Jupiter", "Saturn", "ASC", "MC"):
        ...
        rows.append(
            ...
            f"<td>{format_position(float(positions[name]))}</td></tr>"
        )
...
<label>تاريخ ووقت الميلاد</label><input name="birth1" value="1994-05-23T03:30:00">
